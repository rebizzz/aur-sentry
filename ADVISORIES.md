# AUR Security Advisories & Threat Radar
...
| `[CRITICAL]` | `microsoft-edge-dev-bin` | 156.0.4285.0-1 | bittin | `SUS_CHMOD_SUID`, `PERSIST_CRON` | [AUR](https://aur.archlinux.org/packages/microsoft-edge-dev-bin) |
| `[CRITICAL]` | `microsoft-edge-beta-bin` | 155.0.4283.13-1 | bittin | `SUS_CHMOD_SUID`, `PERSIST_CRON` | [AUR](https://aur.archlinux.org/packages/microsoft-edge-beta-bin) |
